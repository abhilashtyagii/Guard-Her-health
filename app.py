...
from implementation import random_forest_test, random_forest_train, random_forest_predict
from implementation_lr import lr_test, lr_train, lr_predict
from implementation_knn import knn_test, knn_train, knn_predict
